...
public class NotificationDAOImpl implements NotificationDAO {
    ...
    public void saveNotification(Notification notification) {
        ...
        String insertSQL = "INSERT INTO Notifications (notificationId, bookingId, message) VALUES (?, ?, ?)";
        ...
        try (Connection connection = getConnection();
            ...
            insertStmt.setInt(2, notification.getBookingId());
    ...
    public Notification getNotificationById(int notificationId) {
        ...
        try (Connection connection = getConnection();
            ...
            if (resultSet.next()) {
                ...
                notification.setBookingId(resultSet.getInt("bookingId"));
                notification.setMessage(resultSet.getString("message"));
                notification.setSentDate(resultSet.getTimestamp("sentDate").toLocalDateTime());
                return notification;
            }
        } catch (SQLException e) {
            e.printStackTrace();
